  ...
  return (
    <div className="">
      <div className="status-live-game-card-content">
        {eventDetails ? (
          <h3>
            {eventDetails.league.name} - {scheduleEvent.blockName} - Best of{" "}
            {eventDetails.match.strategy.count}
          </h3>
        ) : null}
        <h3>
        ...
        <div className="live-game-stats-header">
          <div className="live-game-stats-header-team-images">
            ...
            <h1>
              ...
              {matchResults ? (
                <div>
                  {matchResults[0].gameWins}-{matchResults[1].gameWins}
                </div>
              ) : null}
              VS
            </h1>
            {TeamCard({
              ...
              index: 1,
              matchResults,
              record: records ? records[1] : undefined,
            })}
          </div>
        </div>
      </div>
    ...
    <h1>
      <div className="live-game-card-team">
        ...
        <span className="outcome">
          {matchResults ? (
            <p className={matchResults[index].outcome}>{matchResults[index].outcome}</p>
          ) : null}
        </span>
        {record ? (
          <span>
