...
export function DisabledGame({ firstWindowFrame, gameMetadata, gameIndex, eventDetails }: Props) {
  ...
  const goldPercentage = getGoldPercentage(
    firstWindowFrame.blueTeam.totalGold,
    firstWindowFrame.redTeam.totalGold,
  );
  let inGameTime = getInGameTime(
  ...
  function getStreamDropdown(eventDetails: EventDetails) {
    ...
    return (
      <select id="streamDropdown" className="footer-notes">
        {dropdown}
      </select>
    );
  }
  ...
  return (
    <div className="status-live-game-card">
      ...
      <div className="status-live-game-card-content">
        ...
        <div className="live-game-stats-header">
          ...
          <div className="live-game-stats-header-dragons">
            ...
            <div className="red-team">
              {firstWindowFrame.redTeam.dragons
                .slice()
                .reverse()
        ...
        <div className="status-live-game-card-table-wrapper">
          <table className="status-live-game-card-table">
            ...
            <tbody>
              {firstWindowFrame.blueTeam.participants.map((player: WindowParticipant, _index) => {
          ...
          <table className="status-live-game-card-table">
            ...
            <tbody>
              {firstWindowFrame.redTeam.participants.map((player: WindowParticipant, _index) => {
                let goldDifference = getGoldDifference(
                  player,
                  "red",
                  gameMetadata,
        ...
        <span className="footer-notes">
          <a
            ...
            href={`https://www.leagueoflegends.com/en-us/news/game-updates/patch-25-${gameMetadata.patchVersion.split(`.`)[1].length > 1 ? gameMetadata.patchVersion.split(`.`)[1] : "" + gameMetadata.patchVersion.split(`.`)[1]}-notes/`}
          >
      ...
      <LiveAPIWatcher
        gameIndex={gameIndex}
        gameMetadata={gameMetadata}
        lastWindowFrame={firstWindowFrame}
