...
export function LiveAPIWatcher({
  lastWindowFrame,
  gameIndex,
  gameMetadata,
  ...
  const [status, setStatus] = useState<StatusWatcher>({
    dragons: {
      blue: lastWindowFrame.blueTeam.dragons.length,
      red: lastWindowFrame.redTeam.dragons.length,
    },
    gameIndex: gameIndex,
    inhibitors: {
      blue: lastWindowFrame.blueTeam.inhibitors,
      red: lastWindowFrame.redTeam.inhibitors,
    },
    ...
    participants: {
      blue: lastWindowFrame.blueTeam.participants,
      red: lastWindowFrame.redTeam.participants,
    },
  });
        ...
        if (status.participants.blue[i].kills !== lastWindowFrame.blueTeam.participants[i].kills) {
          toastArray.push(() => {
            createToast(
              ...
              lastWindowFrame.blueTeam.participants[i].kills - status.participants.blue[i].kills,
            );
          });
          isPlaying = true;
        }
        ...
        if (status.participants.red[i].kills !== lastWindowFrame.redTeam.participants[i].kills) {
          toastArray.push(() => {
            createToast(
              ...
              lastWindowFrame.redTeam.participants[i].kills - status.participants.red[i].kills,
            );
          });
          isPlaying = true;
        }
